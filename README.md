...
> [!WARNING]
> This version of the Website is now `DEPRECATED`. The website has been remade in Blazor/.NET/C# in the following repo : [Nano-Backup-Website](https://github.com/Nano-DNA-Studios/Nano-Backup-Website)
